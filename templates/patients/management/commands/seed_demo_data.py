...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for i, data in enumerate(DEMO_PATIENTS):
            ...
            risk_icon = { 'Critical': '🚨', 'High': '⚠️', 'Medium': '🔶', 'Low': '✅' }
        ...
        self.stdout.write('')
        self.stdout.write(self.style.SUCCESS(f'✅ Created {created_patients} patients, {created_triage} triage records'))
        self.stdout.write(self.style.SUCCESS('✅ Dashboard is now populated and ready for demo'))
        self.stdout.write('')
        self.stdout.write('  Risk breakdown:')
        self.stdout.write('    🚨 Critical : 2 patients')
        self.stdout.write('    ⚠️  High     : 2 patients')
